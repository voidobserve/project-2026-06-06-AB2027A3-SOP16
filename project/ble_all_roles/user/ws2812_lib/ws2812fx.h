...
#define DEFAULT_SPEED      (uint16_t)UWS_SPEED_DEFAULT  // 500
...
#define SIZE_SMALL   (uint8_t)B00000000 //1
#define SIZE_MEDIUM  (uint8_t)B00000010 //3
...
WS2812FX_show_cover_ptr(void (*customShowFunc)(void)),
*WS2812FX_show_get_ptr(void),
WS2812FX_show(void);
